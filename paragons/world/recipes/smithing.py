...
class SmeltIronRecipe(SkillRecipe):
    """
    Smelting metal ore into iron ingots.
    """
    skill = ("smithing", 1)
    exp_gain = 1
    ...
    output_prototypes = [
        {
            ...
            "tags": [
                ("short iron blade", "crafting_material")
            ],
            "value": 7
        }
    ]
    ...
    output_prototypes = [
        {
            ...
            "desc": "A large metal pommel, useful for balancing a very heavy weapon.",
...
class LargeHiltGuardRecipe(SkillRecipe):
    """
    Smith metal into a large guard for a bladed weapon.
    """
    skill = ("smithing", 15)
    exp_gain = 3
...
class CopperFineWireRecipe(SkillRecipe):
    ...
    tool_tags = ["drawing_die", "smithing_tongs"]
...
class IronChainmailShirtRecipe(SkillRecipe):
    ...
    consumable_tags = ["heavy iron wire" * 3]
    output_prototypes = ["IRON_CHAUSSES"]


class HeavyIronNeedleRecipe(SkillRecipe):
    """
...
class HeavyCopperNeedleRecipe(SkillRecipe):
    """
